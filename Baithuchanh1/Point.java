...
public class Point {
    ...
    static void ptdt(Point thu1, Point thu2) {
        double n1 = thu2.x - thu1.x;
        double n2 = thu2.y - thu1.y;
        double c = -(n1 * thu1.x + n2 * thu1.y);
        System.out.println("Phuong trinh qua 2 diem la: " +n1+" * x + "+n2+" * y + "+c+" = 0");
    }
    ...
    public static void main(String[] args){
        ...
        System.out.println("Tinh khoang cach giua 2 diem");
        System.out.println("Tinh chu vi va dien tich cua tam giac");
